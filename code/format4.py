...
"""
Objective:Format
Parameter:intersection_id,tollgate_id,week,start_time,wind_direction,wind_speed,temperature,rel_humidity,precipitation
...
def format(in_file):
	...
	for i in range(len(data)):
		...
		outline = avg_travel_time +' '+' '.join(['0:'+intersection_id,'1:'+each_data[1],'2:'+each_data[2],'3:'+str(start_time),
			'4:'+each_data[7],'5:'+each_data[8],'6:'+each_data[9],'7:'+each_data[10],'8:'+each_data[11]])+'\n'
